...
public class SwitchButton extends CompoundButton {
	...
	private void init(AttributeSet attrs) {
		...
		if (!mIsThumbUseDrawable && mThumbColor == null) {
			mThumbColor = com.cqupt.xmpp.utils.ColorUtils.generateThumbColorWithTintColor(mTintColor);
		...
		if (!mIsBackUseDrawable && mBackColor == null) {
			mBackColor = com.cqupt.xmpp.utils.ColorUtils.generateBackColorWithTintColor(mTintColor);
